        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Manajemen Perlengkapan Umrah</h1>
                    </div>
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="/dashboard/inventory/create">
                                        ...
                                        <tbody>
                                            @foreach ($inventories as $key => $inventory)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/dashboard/inventory/{{ $inventory->id }}/edit"
                                                        ...
                                                        <form action="/dashboard/inventory/{{ $inventory->id }}"
