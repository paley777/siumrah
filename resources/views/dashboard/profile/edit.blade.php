                                ...
                                <form class="row g-2 responsive-small fw-semibold" method="post"
                                    ...
                                    <div class="col-md-4 position-relative">
                                        ...
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="name" value="{{ Auth()->user()->name }}" placeholder="Isi Nama Lengkap"
                                            required>
                                    </div>
                                    <div class="col-md-6 position-relative">
                                        <label for="validationCustom01" class="form-label">Email<span
                                                class="text-danger">*</span></label>
                                        <input type="email" value="{{ Auth()->user()->email }}" id="validationCustom01"
